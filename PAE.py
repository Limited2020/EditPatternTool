...
class DemoClass(tk.Tk):
    ...
    def createWidgets(self):
        ...
        ### add maxReptNum
        self.ety_maxReptNum = tk.Entry(topframe, width=30)
        self.ety_maxReptNum.grid(row=2, column=1)

        self.contents_maxReptNum = StringVar()
        self.contents_maxReptNum.set("65535")
        self.ety_maxReptNum.config(textvariable=self.contents_maxReptNum)
    ...
    def SayHello(self):  # (, ATPFile, CSVFile, PinName, Mode, TimeMode, MaxReptNum):
        ATPFile = ATPfilename
        ...
        MaxReptNum = self.ety_maxReptNum.get()
        main4(ATPFile, CSVFile, PinName, Mode, TimeMode, MaxReptNum)
